 ...
 */
package io.openmessaging.engine.include;


import io.openmessaging.engine.constant.DataUnit;
...
import static io.openmessaging.engine.util.Preconditions.checkPositionIndex;
import static io.openmessaging.engine.util.Preconditions.checkPositionIndexes;
...
public final class Slice {
    ...
    public Slice(Long length){
        this.data = new byte[length.intValue()];
        this.offset = 0;
